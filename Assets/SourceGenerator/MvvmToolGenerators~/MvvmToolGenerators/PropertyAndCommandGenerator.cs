...
public class PropertyAndCommandGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        Dictionary<INamedTypeSymbol, List<IFieldSymbol>> classFieldPairs =
            GetClassFieldsPairs(receiver.ClassesWithAttribute, compilation);
    ...
    private static void AddSourceForCommands(GeneratorExecutionContext context)
    {
        ...
        foreach (ClassDeclarationSyntax classDeclarationSyntax in receiver.ClassesWithAny)
        {
        ...
        List<ClassDeclarationSyntax> classesWithAttribute, Compilation compilation)
    {
        ...
        foreach (ClassDeclarationSyntax classWithAttribute in classesWithAttribute)
        {
            ...
            // Field
            List<IFieldSymbol> fieldsWithAttribute = new();
    ...
    private static string GetSourceForProperties(INamedTypeSymbol classSymbol, List<IFieldSymbol> fields,
        bool isAttribute)
    {
        var sb = new StringBuilder();
    ...
    private class SyntaxReceiver : ISyntaxReceiver
    {
        ...
        public List<ClassDeclarationSyntax> ClassesWithAny { get; } = [];
        ...
        public void OnVisitSyntaxNode(SyntaxNode node)
        {
                ...
                interfaceClass.BaseList.Types.Any(t => t.Type.ToString() == "INotifyPropertyChanged"))
            {
                ...
                ClassesWithAny.Add(interfaceClass);
            }
                     ...
                     }))
            {
                ...
                ClassesWithAny.Add(attributeClass);
            }
        }
    }
}