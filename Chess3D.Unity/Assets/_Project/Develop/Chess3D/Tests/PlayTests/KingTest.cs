...
//             var game = Object.FindObjectOfType<Game>();
//
//             Piece kingGiven = game._board.GetSquare("e1").GetPiece();
//             Piece rookGiven = game._board.GetSquare("h1").GetPiece();
//
//             yield return Move("e1g1");
//
//             Piece kingExpected = game._board.GetSquare("g1").GetPiece();
//             Piece rookExpected = game._board.GetSquare("f1").GetPiece();
