...
//         {
//             game.Construct(board, competitors, cameraController, uciBuffer,
//                 _turnColor, gameSettingsContainer, menuStateMachine);
//         }
//
//         // Done
...
//             instance.Construct(game, _clock, uiCamera);
//         }
//
//         // Done
...
//             cameraController.Construct(game, rotateCameraToColor, isAutoRotationOn);
//         }
//
//         // Done
...
//             board.Construct(game, uciBuffer, _fenFromString, _turnColor);
//
//             board.Build();
//             RotateBoard();
//         }
...
//         {
//             fenFromBoard.Construct(game, board, uciBuffer, _gameSettings.CurrentFen);
//         }
//
//         // TODO: only offline human
...
//
//             competitors.Construct(game, playerWhite, playerBlack, _turnColor);
//         }
//
//         // Same
