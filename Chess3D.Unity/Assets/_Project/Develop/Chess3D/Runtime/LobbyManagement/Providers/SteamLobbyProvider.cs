...
using Chess3D.Runtime.LobbyManagement.Providers;
...
namespace LobbyManagement.Providers
{
...
#endif
    {
        ...
        public event UnityAction<List<Chess3D.Runtime.LobbyManagement.FriendItem>> OnFriendListPulled;
...
#pragma warning restore IDE0052 // Remove unread private members
        ...
        public Task<List<Chess3D.Runtime.LobbyManagement.FriendItem>> GetFriendsAsync(LobbyManager.FriendFilter filter)
        {
            if (!IsSteamClientAvailable)
                return default;

            var friends = new List<Chess3D.Runtime.LobbyManagement.FriendItem>();
        ...
        public Task InviteFriendAsync(Chess3D.Runtime.LobbyManagement.FriendItem user)
        {
        ...
        private Chess3D.Runtime.LobbyManagement.FriendItem CreateFriendUser(Steamworks.CSteamID steamId)
        {
            var displayName = Steamworks.SteamFriends.GetFriendPersonaName(steamId);
            ...
            return new Chess3D.Runtime.LobbyManagement.FriendItem()
            {
                Id = steamId.m_SteamID.ToString(),
                Name = displayName,
                Image = avatar
