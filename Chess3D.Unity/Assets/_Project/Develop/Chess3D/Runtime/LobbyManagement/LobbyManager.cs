...
namespace LobbyManagement
{
    public class LobbyManager : MonoBehaviour
    {
        ...
        public UnityEvent<List<Chess3D.Runtime.LobbyManagement.FriendItem>> OnFriendListPulled = new UnityEvent<List<Chess3D.Runtime.LobbyManagement.FriendItem>>();
        ...
        public void PullFriends(FriendFilter filter)
        {
            ...
            {
                EnsureProviderSet();
                List<Chess3D.Runtime.LobbyManagement.FriendItem> friends = await _currentProvider.GetFriendsAsync(filter);
        ...
        public void InviteFriend(Chess3D.Runtime.LobbyManagement.FriendItem user)
        {
            RunTask(async () =>
            {
                EnsureProviderSet();
